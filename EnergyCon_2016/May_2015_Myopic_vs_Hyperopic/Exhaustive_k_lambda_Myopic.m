function [ Save_vec_M_1, Save_vec_M_2, Save_vec_M_3, OptK_vec_M_1, OptK_vec_M_2, OptK_vec_M_3, Cost_matrix_1, Cost_matrix_2, Cost_matrix_3 ] = Exhaustive_k_lambda_Myopic()
...
%
 ...
 filename = 'Eco_lambda_M.tex';
 fid=fopen(['Data_in_TEX/' filename],'w');
 time =clock;
 infos = ['% Obtained from Exhaustive_k_lambda_Myopic(), run on ', int2str(time(3)), '/', int2str(time(2)), '/',int2str(time(1)), ' at ', int2str(time(4)), ':', int2str(time(5)), ':', int2str(time(6)), 'when $\theta$ = ', num2str(Tht_fix)]; 
 fprintf(fid,'%s\n',infos);
 ...
 fprintf(fid,'%s\n','\addplot coordinates{');
 for i = 1:1:nb_Lambda
     fprintf(fid,'%s','(',num2str(L_vec(i)),',',num2str(Save_vec_M_1(1,i)), ')');
 end
 fprintf(fid, '%s\n', '};');
 ...
 fprintf(fid,'%s\n','\addplot coordinates{');
 for i = 1:1:nb_Lambda
     fprintf(fid,'%s','(',num2str(L_vec(i)),',',num2str(Save_vec_M_2(1,i)), ')');
 end
 fprintf(fid, '%s\n', '};');
 ...
 fprintf(fid,'%s\n','\addplot coordinates{');
 for i = 1:1:nb_Lambda
     fprintf(fid,'%s','(',num2str(L_vec(i)),',',num2str(Save_vec_M_3(1,i)), ')');
 end
 fprintf(fid, '%s\n', '};');
 ...
 fprintf(fid,'%s\n','\addplot coordinates{');
 for i = 1:1:nb_Lambda
     fprintf(fid,'%s','(',num2str(L_vec(i)),',',num2str(OptK_vec_M_1(1,i)), ')');
 end
 fprintf(fid, '%s\n', '};');
 ...
 fprintf(fid,'%s\n','\addplot coordinates{');
 for i = 1:1:nb_Lambda
     fprintf(fid,'%s','(',num2str(L_vec(i)),',',num2str(OptK_vec_M_2(1,i)), ')');
 end
 fprintf(fid, '%s\n', '};');
 ...
 fprintf(fid,'%s\n','\addplot coordinates{');
 for i = 1:1:nb_Lambda
     fprintf(fid,'%s','(',num2str(L_vec(i)),',',num2str(OptK_vec_M_3(1,i)), ')');
 end
 fprintf(fid, '%s\n', '};');
